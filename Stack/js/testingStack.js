...
QUnit.test('When two values are pushed then one is popped, size is one',
	function(assert) {
		this.stack.push(1);
		this.stack.push(2);
		this.stack.pop();
...
QUnit.test('When one and two are pushed two and one are popped',
	function(assert) {
		this.stack.push(1);
		this.stack.push(2);
...
QUnit.test('Given stack with one two pushed, find one and two',
	function(assert) {
		this.stack.push(1);
		this.stack.push(2);
...
QUnit.test('Given a stack with no two, find two returns null',
	function(assert) {
