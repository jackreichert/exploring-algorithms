...
QUnit.test('Add two values, searchValueAt(1) returns second value',
	function(assert) {
		this.linkedList.add(5);
		this.linkedList.add(8);
...
QUnit.test('Add two values, searchValueAt(0) returns first value',
	function(assert) {
		this.linkedList.add(5);
		this.linkedList.add(8);
		assert.ok(5 === this.linkedList.searchValueAt(0), 'Passed!');
...
QUnit.test('Add value, remove node, add value, first is second value',
	function(assert) {
		this.linkedList.add(5);
		this.linkedList.removeNodeAt(0);
		this.linkedList.add(8);
...
QUnit.test('Add two values, remove at third position, length is 2',
	function(assert) {
		this.linkedList.add(5);
		this.linkedList.add(8);
...
QUnit.test('Add two values, remove second, first is value and next is empty',
	function(assert) {
		this.linkedList.add(5);
		this.linkedList.add(8);
		this.linkedList.removeNodeAt(1);
...
QUnit.test('Add two values, remove first, first is second value',
	function(assert) {
		this.linkedList.add(5);
		this.linkedList.add(8);
		this.linkedList.removeNodeAt(0);
