...
class TestInsertionSort(unittest.TestCase):
    ...
    def test_1(self):
        print("{} When 1 is given to [], getPositionForNewVal returns 0".format(inspect.stack()[0][3]))
        self.assertEqual(0, self.insertionSort.getPositionForNewVal(1,[]))
    ...
    def test_3(self):
        ...
        self.assertEqual(3, self.insertionSort.getPositionForNewVal(9,[2,7,4]))

    def test_4(self):
        testList = [2,4,6,3,5]
        print("{} Slice index 0 from {}, should return [4,6,3,5]".format(inspect.stack()[0][3],testList))
        self.assertEqual([4,6,3,5], self.insertionSort.slice(testList,0,1))

    def test_5(self):
        testList = [2,4,6,3,5]
        print("{} Slice index 5 from {}, should return [2,4,6,3,5]".format(inspect.stack()[0][3],testList))
    ...
    def test_10(self):
        testList = [3,2,5,4,7,4]
        print("{} When {} is given, sort returns [2,3,4,4,5,7]".format(inspect.stack()[0][3],testList))
        self.assertEqual([2,3,4,4,5,7],self.insertionSort.sort(testList))

    def test_11(self):
        testList = [8682,2602,5961,4659,432,8230,111,3921,2841,5913,4876,800,6748,5720,4660,327,2305,3571,9919,8277,6168,2305,3359,9292,7043]
        print("{} When {} is given, sort returns [111,327,432,800,2305,2305,2602,2841,3359,3571,3921,4659,4660,4876,5720,5913,5961,6168,6748,7043,8230,8277,8682,9292,9919]".format(inspect.stack()[0][3],testList))
        self.assertEqual([111,327,432,800,2305,2305,2602,2841,3359,3571,3921,4659,4660,4876,5720,5913,5961,6168,6748,7043,8230,8277,8682,9292,9919],self.insertionSort.sort(testList))
