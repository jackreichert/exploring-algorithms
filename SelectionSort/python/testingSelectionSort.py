...
class TestSelectionSort(unittest.TestCase):
    ...
    def test_1(self):
        print("Can create SelectionSort object")
        self.assertTrue(type(self.selectionSort) is SelectionSort)

    def test_2(self):
        print("When given list of unique positive numbers, can find lowest number")
        numberList = [3,2,5]
    ...
    def test_4(self):
        print("When given list of numbers, can find lowest number")
        numberList = [3,2,2,5]
        self.assertEqual(numberList[self.selectionSort.findLowest(numberList)], 2)

    def test_5(self):
        print("Swapping numbers in small list, where from > to")
        numberList = [2,3,4]
